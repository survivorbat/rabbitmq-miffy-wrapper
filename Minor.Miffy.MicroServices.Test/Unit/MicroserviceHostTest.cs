...
namespace Minor.Miffy.MicroServices.Test.Unit
{
    ...
    public class MicroserviceHostTest
    {
        ...
        public void ContextIsProperlySet()
        {
            ...
            // Act
            var host = new MicroserviceHost(context, null, logger.Object);
        ...
        public void CreateListenerIsCalledForAllGivenListeners(int listenerAmount)
        {
            ...
            var host = new MicroserviceHost(contextMock.Object, listeners, logger.Object);
        ...
        [TestMethod]
        public void StartListeingIsCalledOnReceiver()
        {
            // Arrange
            var contextMock = new Mock<IBusContext<IConnection>>();
            var receiverMock = new Mock<IMessageReceiver>();
